...
<body>
    ...
    include('config.php');
    $ID=$_GET['id'];
    $up = mysqli_query($con, "select * from `ouvrier` where id='$ID'");
...
if(isset($_POST['update'])){
   ...
   $grad=$_POST['grad'];
   $debut=$_POST['debut'];
    $update = "UPDATE `ouvrier` SET nom='$NAME',datedebut='$debut', grade=' $grad',password='$password', prenom='$Prenom', image='$image_up' ,email='$email' WHERE id='$ID'";
    ...
    <center>
        <div class="main">
            <form action="" method="post" enctype="multipart/form-data">
                <h2>Modifier les informations du Ouvrier</h2>
                ...
                <br>
                <input type="text" name='grad' value='<?php echo $data['grade']?>'>
                <input type="text" name='debut' value='<?php echo $data['datedebut']?>'>

...
<body>
    ...
    include('config.php');
    $ID=$_GET['id'];
    $up = mysqli_query($con, "SELECT * FROM bloc WHERE nom ='$ID'");
...
if(isset($_POST['update'])){
    ...
    ;
    $idp= $_POST['idp'];
    $update = "UPDATE `bloc` SET nom='$NAME' ,idpepinier='$idp' WHERE nom='$ID'";
    ...
    <center>
        <div class="main">
            <form action="" method="post" enctype="multipart/form-data">
                <h2>Modifier les informations du bloc</h2>

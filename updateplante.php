...
<body>
    ...
    include('config.php');
    $ID=$_GET['id'];
    $up = mysqli_query($con, "select * from `plants` where id='$ID'");
...
if(isset($_POST['update'])){
    ...
    $idp= $_POST['idp'];
    $update = "UPDATE `plants` SET nom='$NAME' , description='$desc', image='$image_up' ,idpepiniere='$idp' WHERE id='$ID'";
    ...
    <center>
        <div class="main">
            <form action="" method="post" enctype="multipart/form-data">
                <h2>Modifier les informations de plante</h2>

...
<body>
    ...
    include('config.php');
    $ID=$_GET['id'];
    $up = mysqli_query($con, "select * from `pépinière` where id='$ID'");
...
if(isset($_POST['update'])){
   ...
   $adresse=$_POST['adresse'];
    ...
    $update = "UPDATE `pépinière` SET nom='$NAME' , adresse='$adresse' WHERE id='$ID'";
    ...
    <center>
        <div class="main">
            <form action="" method="post" enctype="multipart/form-data">
                <h2>Modifier les informations de Pépinière</h2>
